...
1. Download the following file:  `webbpsf-data-0.6.0.tar.gz <http://www.stsci.edu/~mperrin/software/webbpsf/webbpsf-data-0.6.0.tar.gz>`_  [approx. 240 MB]
2. Untar ``webbpsf-data-0.6.0.tar.gz`` into a directory of your choosing.
